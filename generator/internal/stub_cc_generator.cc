...
bool GenerateClientStubCC(pb::ServiceDescriptor const* service,
  ...
  p->Print(
      ...
      "    return std::unique_ptr<$stub_class_name$>(\n"
      "        new Default$stub_class_name$(std::move(stub)));\n"
      "}\n"
      "\n"
      "std::unique_ptr<$stub_class_name$> Create$stub_class_name$(\n"
      "    std::shared_ptr<grpc::ChannelInterface> channel) {\n"
      "    auto grpc_stub = std::shared_ptr<$grpc_stub_fqn$::StubInterface>(\n"
      "        $grpc_stub_fqn$::NewStub(std::move(channel)));\n"
      "    return Create$stub_class_name$(std::move(grpc_stub));\n"
      "}\n"
      "\n"
      "std::unique_ptr<$stub_class_name$> Create$stub_class_name$(\n"
      ...
      "    return Create$stub_class_name$(std::move(channel));\n"
      "}\n");
